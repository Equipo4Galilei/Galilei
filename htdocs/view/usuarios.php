...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                <button class="btn btn-light" style="margin: 8px;" onclick="create_table()">Mostrar productos</button>
    ...
    <h2 style="text-align: center; color: white;">Administracion de usuarios y/o Equipos de computo</h2>
    <h4 style="text-align: center; color: white;">Actualmente se encuentra en la pestana Administracion De Equipos Computo</h4>
