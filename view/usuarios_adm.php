        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  style="color: white;" onclick="create_table()"><h6>Mostrar Usuarios</h6></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: white;" onclick="eliminar_reg()"><h6>Eliminar Usuarios</h6></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: white;" onclick="open_reg_modal()"><h6>Agregar Usuarios</h6></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: white;" onclick="table_mod()"><h6>Modificar Usuarios</h6></a>
                    </li>
